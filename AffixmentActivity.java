...
public class AffixmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        RelativeLayout layoutAffixment = (RelativeLayout) findViewById(R.id.layoutAffixment);
        String path = getIntent().getStringExtra("mapPath");
        mImage = new MapView(getApplicationContext(), path);
        assert layoutAffixment != null;
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        layoutAffixment.addView(mImage, params);
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                "Affixment Page", // TODO: Define a title for the content shown.
                // TODO: If you have web page content that matches this app activity's content,
                // make sure this auto-generated web page URL is correct.
                // Otherwise, set the URL to null.
                Uri.parse("http://host/path"),
                // TODO: Make sure this auto-generated app URL is correct.
                Uri.parse("android-app://tk.parmclee.o_droid/http/host/path")
        );
